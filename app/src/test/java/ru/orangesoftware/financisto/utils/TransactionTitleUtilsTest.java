...
public class TransactionTitleUtilsTest {
    ...
    public void test_should_generate_title_for_regular_transactions() {
        ...
        assertEquals("", generateTransactionTitle(sb(), null, null, null, Category.NO_CATEGORY_ID, "<NO_CATEGORY>"));
        assertEquals("Payee", generateTransactionTitle(sb(), "Payee", null, null, Category.NO_CATEGORY_ID, "<NO_CATEGORY>"));
    }
    ...
    public void test_should_generate_title_for_a_split() {
        ...
        assertEquals("[Split...]", generateTransactionTitle(sb(), null, null, null, Category.SPLIT_CATEGORY_ID, "<SPLIT_CATEGORY>"));
    }
