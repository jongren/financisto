...
public abstract class AbstractTransactionActivity extends AbstractActivity implements CategorySelector.CategorySelectorListener {
    ...
    protected void requestImage(Sources source) {
        ...
        if (source == Sources.CAMERA) {
            ...
            String readPermission = android.os.Build.VERSION.SDK_INT >= 33 ? "android.permission.READ_MEDIA_IMAGES" : android.Manifest.permission.READ_EXTERNAL_STORAGE;
            if (RequestPermission.isRequestingPermission(this, readPermission)) {
                return;
            }
